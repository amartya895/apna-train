...
function PnrStatus() {
  ...
  return (
    <div className="bg-slate-50 w-2/3  ml-14 mt-14 mb-10 p-10 shadow-md flex-col justify-center items-center rounded-md">
     {
      checkPnr ? <PnrStatusCard checkFunction={handlePnrSearch}/>:<>
      ...
      <div className=" bg-slate-100 shadow-md mt-2 p-5  rounded-sm">
        ...
        <button className="w-full mt-3 p-2 text-xl bg-orange-400 duration-300 text-white rounded-md border hover:bg-orange-300 " onClick={handlePnrSearch}>
          Search
        </button>
      </div>
      </>
